function results = balle2010(y1,speed,airFlag,tau, m1, m2, m3, m4)      %add KC
%% balle2010 - Program to compute the trajectory of a package  
%         using the midpoint method.                              
% invoke as: balle2010(500,90,1, 0.0001, 4, 8, 12, 16)
% Original by AJG; modified by Katrina Carver and Sarah Powell 20200404           
help balle2010; % print header 

% mass combinations that illustrate comparisons well:    4, 8, 12, 16; 5, 10, 50, 100; 5, 50, 100, 500       %add KC% mass combinations that illustrate comparisons well:    4, 8, 12, 16; 5, 10, 50, 100; 5, 50, 100, 500       %add KC
...
last3_x1=[rx1(end-2), rx1(end-1), rx1(end)]; % creating a vector of the last 3 x-components of r1
last3_y1=[ry1(end-2), ry1(end-1), ry1(end)]; % creating a vector of the last 3 y-components of r1
...
corrected_range1=intrpf(0,last3_y1,last3_x1); %Finds the horizontal range by interpolating between the last 3 position points.
% repeat for other 3 masses             % section added KC
...
corrected_time1=(istep*tau)-((rx1(end)-corrected_range1)/state1(3)); 
