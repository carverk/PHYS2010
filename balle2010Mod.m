...
% KC change log 04232020: for easier comparison of sphere/cube projectiles:
%                  edited program to specify when projectile is a
%                  sphere and when it is a cube, i.e. in print
%                  statements and graph titles
%                  now displays cube and sphere graphs in different
%                  windows
...
%% * Print maximum range and time of flight and state shape of projectile %modKC

fprintf('Maximum range of the %gkg ' + txt + ' mass is %g meters\n',m1,corrected_range1); %prints max range           %mod KC
fprintf('Time of flight of the %gkg ' + txt + ' mass is %.6f seconds\n\n',m1,corrected_time1); %prints time of flight   %mod KC
...
% display different shapes in different windows for easy comparison         %add KC
if shape == 0    
...
plot(xplot1,yplot1, '-', xplot2,yplot2, '-', xplot3,yplot3, '-', xplot4,yplot4, '-');  %add KC
ylim([-10 550]);
xlabel('Range (m)');  ylabel('Height (m)');
title("Projectile motion " + txt);                                          %mod KC

legend(txt1, txt2, txt3, txt4);                                             %add KC
